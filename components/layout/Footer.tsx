          ...
          <div className="bg-[#121124] rounded-b-[16px] sm:rounded-b-[22px] border-x border-b border-white/10 text-white shadow-[0_25px_60px_rgba(0,0,0,0.35)] relative overflow-hidden pt-8 sm:pt-12 p-8 sm:p-14 lg:p-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-14 relative z-10">
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                {/* Redesigned Luxury Social Media Buttons */}
                <div className="flex items-center gap-3 pt-3">
                  ...
                  <a
                    ...
                    className="w-11 h-11 rounded-2xl bg-gradient-to-br from-rose-500/20 to-purple-600/20 hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] border border-rose-500/30 hover:border-transparent text-white flex items-center justify-center transition-all duration-300 shadow-lg shadow-rose-950/40 hover:shadow-rose-500/30 hover:-translate-y-1 hover:scale-105 active:scale-95 group"
                  >
                    <svg className="w-5 h-5 fill-current text-rose-200 group-hover:text-white transition-colors" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    aria-label="LinkedIn"
                    className="w-11 h-11 rounded-2xl bg-sky-500/15 hover:bg-[#0A66C2] border border-sky-500/30 hover:border-transparent text-white flex items-center justify-center transition-all duration-300 shadow-lg shadow-sky-950/40 hover:shadow-sky-500/30 hover:-translate-y-1 hover:scale-105 active:scale-95 group"
                  >
                    <svg className="w-5 h-5 fill-current text-sky-200 group-hover:text-white transition-colors" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    aria-label="Facebook"
                    className="w-11 h-11 rounded-2xl bg-blue-500/15 hover:bg-[#1877F2] border border-blue-500/30 hover:border-transparent text-white flex items-center justify-center transition-all duration-300 shadow-lg shadow-blue-950/40 hover:shadow-blue-500/30 hover:-translate-y-1 hover:scale-105 active:scale-95 group"
                  >
                    <svg className="w-5 h-5 fill-current text-blue-200 group-hover:text-white transition-colors" viewBox="0 0 24 24">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    aria-label="WhatsApp"
                    className="w-11 h-11 rounded-2xl bg-emerald-500/15 hover:bg-[#25D366] border border-emerald-500/30 hover:border-transparent text-white flex items-center justify-center transition-all duration-300 shadow-lg shadow-emerald-950/40 hover:shadow-emerald-500/30 hover:-translate-y-1 hover:scale-105 active:scale-95 group"
                  >
                    <svg className="w-5 h-5 fill-current text-emerald-200 group-hover:text-white transition-colors" viewBox="0 0 24 24">
